...
GLEECH_COMMAND = os.environ.get("GLEECH_COMMAND", "gleech2")
GLEECH_UNZIP_COMMAND = os.environ.get("GLEECH_UNZIP_COMMAND", "gleechunzip2")
GLEECH_ZIP_COMMAND = os.environ.get("GLEECH_ZIP_COMMAND", "gleechzip2")
YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "ytdl2")
GYTDL_COMMAND = os.environ.get("GYTDL_COMMAND", "gytdl")
RCLONE_CONFIG = os.environ.get("RCLONE_CONFIG", "")
DESTINATION_FOLDER = os.environ.get("DESTINATION_FOLDER", "Maxx TD2")
INDEX_LINK = os.environ.get("INDEX_LINK", "")
TELEGRAM_LEECH_COMMAND = os.environ.get("TELEGRAM_LEECH_COMMAND", "tgfile_leech2")
TELEGRAM_LEECH_UNZIP_COMMAND = os.environ.get(
    "TELEGRAM_LEECH_UNZIP_COMMAND", "tgfile_extract2"
)
CANCEL_COMMAND_G = os.environ.get("CANCEL_COMMAND_G", "cancel2")
GET_SIZE_G = os.environ.get("GET_SIZE_G", "getsize2")
STATUS_COMMAND = os.environ.get("STATUS_COMMAND", "status2")
SAVE_THUMBNAIL = os.environ.get("SAVE_THUMBNAIL", "savethumbnail2")
CLEAR_THUMBNAIL = os.environ.get("CLEAR_THUMBNAIL", "clearthumbnail2")
UPLOAD_AS_DOC = os.environ.get("UPLOAD_AS_DOC", "False")
PYTDL_COMMAND = os.environ.get("PYTDL_COMMAND", "pytdl2")
GPYTDL_COMMAND = os.environ.get("GPYTDL_COMMAND", "gpytdl")
LOG_COMMAND = os.environ.get("LOG_COMMAND", "log")
CLONE_COMMAND_G = os.environ.get("CLONE_COMMAND_G", "gclone2")
UPLOAD_COMMAND = os.environ.get("UPLOAD_COMMAND", "upload2")
RENEWME_COMMAND = os.environ.get("RENEWME_COMMAND", "renewme2")
RENAME_COMMAND = os.environ.get("RENAME_COMMAND", "rename2")
TOGGLE_VID = os.environ.get("TOGGLE_VID", "upload_vid2")
TOGGLE_DOC = os.environ.get("TOGGLE_DOC", "upload_doc2")
